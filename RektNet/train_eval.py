...
def main():
    ...
    parser.add_argument('--train_dataset_uri', default='D:\\Python Projects\\Rektnet\\MITRepo\\RektNet\\dataset\\rektnet_label.csv', help='training dataset csv directory path')
    ...
    parser.add_argument('--dataset_path', type=str, help='path to image dataset',default='D:\\Python Projects\\Rektnet\\MITRepo\\RektNet\\dataset\\RektNet_Dataset')
    ...
    parser.add_argument('--geo_loss_gamma_vert', default=0.038, type=float, help='gamma for the geometric loss (horizontal)')
    parser.add_argument('--geo_loss_gamma_horz', default=0.055, type=float, help='gamma for the geometric loss (vertical)')
